...
public class Player {// ------------------------- name=0->곰 플레이어, name=1->호랑이 플레이어
	...
	private String tigerWithRockLeftimagePath = "./src/assets/image/돌든호랑이.png";
	private String tigerWithRockRightimagePath = "./src/assets/image/돌든호랑이_오른쪽.png";
	private String bearWithRockLeftimagePath = "./src/assets/image/돌든곰_왼쪽.png";
	private String bearWithRockRightimagePath = "./src/assets/image/돌든곰.png";
